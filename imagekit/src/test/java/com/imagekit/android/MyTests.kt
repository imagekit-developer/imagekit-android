...
class MyTests {
    ...
    fun urlConstructionTransformation1() {
        val expectedTransformation =
            "https://ik.imagekit.io/demo/img/tr:w-300.00,h-200.00,cm-pad_resize,bg-F3F3F3/plant.jpeg?sdk-version=android-${BuildConfig.API_VERSION}"
    ...
    fun urlConstructionTransformation2() {
        val expectedTransformation =
            "https://ik.imagekit.io/demo/default-image.jpg?sdk-version=android-${BuildConfig.API_VERSION}&tr=h-400.00,ar-3-2"
        val actualTransformation =
    ...
    fun urlConstructionTransformation3() {
        val expectedTransformation =
            "https://ik.imagekit.io/demo/medium_cafe_B1iTdD0C.jpg?sdk-version=android-${BuildConfig.API_VERSION}&tr=oi-logo-white_SJwqB4Nfe.png,ox-10,oy-20"
        val actualTransformation =
    ...
    fun urlConstructionTransformation5() {
        val expectedTransformation =
            "https://ik.imagekit.io/demo/img/plant.jpeg?sdk-version=android-${BuildConfig.API_VERSION}&tr=w-400,ot-Hand with a green plant,otc-264120,ots-30,ox-10,oy-10"
        val actualTransformation =
            ImageKit.getInstance()
    ...
    fun urlConstructionTransformation6() {
        val expectedTransformation =
            "https://ik.imagekit.io/demo/img/default-image.jpg?sdk-version=android-${BuildConfig.API_VERSION}&tr=w-400.00,h-300.00:rt-90"
        val actualTransformation =
            ImageKit.getInstance()
